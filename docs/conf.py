"""Sphinx configuration for django-channels-spectacular docs."""
...
# ── Project info ─────────────────────────────────────────────────────────────
project = "django-channels-spectacular"
copyright = "2026, Ibukun Olaifa"
author = "Ibukun Olaifa"

# Import version from the package itself.
from channels_spectacular import __version__  # noqa: E402
...
# ── HTML / Furo theme ─────────────────────────────────────────────────────────
html_theme = "furo"
html_title = "django-channels-spectacular"
...
html_theme_options = {
    ...
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/ibukun-brain/django-channels-spectacular",
            "html": (
